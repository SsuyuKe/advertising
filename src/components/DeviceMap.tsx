          ...
          {selectedDevice && (
            ...
            >
              <div className="flex flex-col items-center justify-center">
                ...
                <ul className="flex flex-col w-full py-2 font-bold">
                  <li className="mb-2">地址: {selectedDevice.address}</li>
                  <li className="mb-2">媒體通路: {selectedDevice.address}</li>
                  <li className="mb-2">
                    螢幕解析度: {selectedDevice.resolutionW}x
                    {selectedDevice.resolutionH}
                  </li>
                  <li className="mb-2">方向直/橫: </li>
                  <li>剩餘秒數: 秒</li>
                </ul>
                {/* TODO: 取消要改，有選才是出現取消，沒選就是選擇 */}
                <button
                  onClick={() => handleDeviceClick(selectedDevice)}
                  className="relative bg-dark text-white px-5 py1 rounded-10px"
                >
                  取消
                </button>
              </div>
